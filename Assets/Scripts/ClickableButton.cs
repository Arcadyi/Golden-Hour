...
public class ClickableButton : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        _spriteRenderer.sprite = normalSprite; // Set the initial sprite to the normal sprite
    ...
    private void OnMouseDown()
    {
        ...
        _spriteRenderer.sprite = heldSprite; // Change to the held sprite
    ...
    {
        if (isPlaying) return; // If the animation is already playing, exit the method
        _spriteRenderer.sprite = hoverSprite; // Change back to the hover sprite
    }
    ...
    private System.Collections.IEnumerator ClickAnimationCoroutine()
    {
        ...
        {
            _audioSource.Play(); // Play the click sound
        }
        ...
        {
            _spriteRenderer.sprite = clickSprites[i]; // Set the sprite to the current click sprite
